...
//		p2Name = console.nextLine();
		...
		p1Name = JOptionPane.showInputDialog("Enter name for player 1");
		p2Name = JOptionPane.showInputDialog("Enter name for player 2");
		...
		while ((player1.size() < MAX_GEMS) && (player2.size() < MAX_GEMS))
		{
			...
			StdDraw.textLeft(0.0, PLAYER1_Y + PLAYER_HALF_HEIGHT - TEXT_HEIGHT, p1Name + ": " + score1);
			StdDraw.textLeft(0.0, PLAYER2_Y + PLAYER_HALF_HEIGHT - TEXT_HEIGHT, p2Name + ": " + score2);
        ...
        if (score1 == score2)
        	...
        	StdDraw.text(0.5, SCORE_Y, p1Name + " wins!");
        else 
        	StdDraw.text(0.5, SCORE_Y, p2Name + " wins!");
